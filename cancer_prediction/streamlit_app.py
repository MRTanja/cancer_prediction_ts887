...
def load_model(path: str = "cancer_model.pkl") -> CancerModel:
    ...
    Args:
        path (str, optional): _description_. Defaults to 'cancer_model.pkl'.
...
def train_and_save_model(
    ...
    Args:
        ...
        filename (str, optional): Path to model save point. Defaults to 'cancer_model.pkl'.

    Returns:
        CancerModel: Trained cancer prediction model
    """
    model = CancerModel()
